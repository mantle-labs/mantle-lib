...
namespace mantle.lib.Model
{
    ...
    public partial class TrackerAssetIssueRequest :  IEquatable<TrackerAssetIssueRequest>, IValidatableObject
    {
        ...
        public TrackerAssetIssueRequest(string recipientDisplayName = default(string), string ownedDisplayName = default(string), int? amount = default(int?), string metaData = default(string))
        {
        ...
        public bool Equals(TrackerAssetIssueRequest input)
        {
            ...
            return 
                ...
                (
                    this.OwnedDisplayName == input.OwnedDisplayName ||
                    (this.OwnedDisplayName != null &&
                    this.OwnedDisplayName.Equals(input.OwnedDisplayName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OwnedDisplayName != null)
                    hashCode = hashCode * 59 + this.OwnedDisplayName.GetHashCode();
                if (this.Amount != null)
