...
namespace mantle.lib.Model
{
    ...
    public partial class AssetTransaction :  IEquatable<AssetTransaction>, IValidatableObject
    {
        ...
        public AssetTransaction(BlockchainStatusEnum? blockchainStatus = default(BlockchainStatusEnum?), string assetId = default(string), string assetDisplayName = default(string), string metaData = default(string), string id = default(string), string batchId = default(string), double? amount = default(double?), string senderDisplayName = default(string), string recipientDisplayName = default(string), long? timestamp = default(long?), bool? isReverted = default(bool?))
        {
