...
namespace mantle.lib.Model
{
    ...
    public partial class KeeperFileVersion :  IEquatable<KeeperFileVersion>
    {
        ...
        public KeeperFileVersion(int? Version = null, string Id = null, BlockchainStatusEnum? BlockchainStatus = null, string OwnerEmail = null, DateTime? CreationDate = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KeeperFileVersion);
        }

        /// <summary>
        /// Returns true if KeeperFileVersion instances are equal
        /// </summary>
        /// <param name="other">Instance of KeeperFileVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeeperFileVersion other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
