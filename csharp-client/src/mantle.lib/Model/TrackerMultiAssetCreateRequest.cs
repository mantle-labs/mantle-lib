...
namespace mantle.lib.Model
{
    ...
    public partial class TrackerMultiAssetCreateRequest :  IEquatable<TrackerMultiAssetCreateRequest>
    {
        ...
        public TrackerMultiAssetCreateRequest(string Name = null, List<string> AssetIds = null, List<string> AssetDisplayNames = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrackerMultiAssetCreateRequest);
        }

        /// <summary>
        /// Returns true if TrackerMultiAssetCreateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TrackerMultiAssetCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackerMultiAssetCreateRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.AssetDisplayNames == other.AssetDisplayNames ||
                    this.AssetDisplayNames != null &&
                    this.AssetDisplayNames.SequenceEqual(other.AssetDisplayNames)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AssetDisplayNames != null)
                    hash = hash * 59 + this.AssetDisplayNames.GetHashCode();
                return hash;
            }
        }
    }
