...
namespace mantle.lib.Model
{
    ...
    public partial class TrackerBatchTransferBulkRequest :  IEquatable<TrackerBatchTransferBulkRequest>, IValidatableObject
    {
        ...
        public TrackerBatchTransferBulkRequest(string assetId = default(string), string recipientEmail = default(string), int? amount = default(int?), string metaData = default(string), List<string> batchIds = default(List<string>))
        {
