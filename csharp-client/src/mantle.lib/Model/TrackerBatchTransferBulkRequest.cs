...
namespace mantle.lib.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrackerBatchTransferBulkRequest :  IEquatable<TrackerBatchTransferBulkRequest>
    {
        /// <summary>
        ...
        public TrackerBatchTransferBulkRequest(string AssetId = null, string RecipientEmail = null, int? Amount = null, string MetaData = null, List<string> BatchIds = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrackerBatchTransferBulkRequest);
        }

        /// <summary>
        /// Returns true if TrackerBatchTransferBulkRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TrackerBatchTransferBulkRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackerBatchTransferBulkRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
