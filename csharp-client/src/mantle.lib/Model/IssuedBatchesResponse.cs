...
namespace mantle.lib.Model
{
    ...
    public partial class IssuedBatchesResponse :  IEquatable<IssuedBatchesResponse>
    {
        ...
        public IssuedBatchesResponse(string AssetDisplayName = null, List<AssetTransaction> Batches = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IssuedBatchesResponse);
        }

        /// <summary>
        /// Returns true if IssuedBatchesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of IssuedBatchesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssuedBatchesResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
