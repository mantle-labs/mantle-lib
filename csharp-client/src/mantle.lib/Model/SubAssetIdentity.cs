...
namespace mantle.lib.Model
{
    ...
    public partial class SubAssetIdentity :  IEquatable<SubAssetIdentity>
    {
        ...
        public SubAssetIdentity(string Id = null, string DisplayName = null)
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SubAssetIdentity);
        }

        /// <summary>
        /// Returns true if SubAssetIdentity instances are equal
        /// </summary>
        /// <param name="other">Instance of SubAssetIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubAssetIdentity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
