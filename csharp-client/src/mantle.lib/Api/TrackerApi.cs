...
namespace mantle.lib.Api
{
    ...
    public partial class TrackerApi : ITrackerApi
    {
        ...
        public ApiResponse<Object> CreateAssetBatchTransferWithHttpInfo (string assetId, string productId, string xApiKey, TrackerBatchTransferRequest request = null, string ownedDisplayName = null)
        {
            ...
            if (productId != null) localVarPathParams.Add("productId", this.Configuration.ApiClient.ParameterToString(productId)); // path parameter
            if (ownedDisplayName != null) localVarHeaderParams.Add("ownedDisplayName", this.Configuration.ApiClient.ParameterToString(ownedDisplayName)); // header parameter
            if (xApiKey != null) localVarHeaderParams.Add("x-api-key", this.Configuration.ApiClient.ParameterToString(xApiKey)); // header parameter
            if (request != null && request.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(request); // http body (model) parameter
        ...
        public ApiResponse< AssetIssueResponse > IssueAssetWithHttpInfo (string assetId, string productId, string xApiKey, TrackerAssetIssueRequest request = null)
        {
            ...
            return new ApiResponse<AssetIssueResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (AssetIssueResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AssetIssueResponse)));
        }
