...
namespace mantle.lib.Api
{
    ...
    public interface IKeeperApi : IApiAccessor
    {
        ...
        /// <param name="productId"></param>
        /// <param name="xApiKey"></param>
        /// <param name="originalFileId"> (optional)</param>
        ...
        ApiResponse<string> GetLinkToDownloadOriginalFileWithHttpInfo (string fileId, string productId, string xApiKey, string originalFileId = null);
        ...
        System.Threading.Tasks.Task<string> GetLinkToDownloadOriginalFileAsync (string fileId, string productId, string xApiKey, string originalFileId = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> GetLinkToDownloadOriginalFileAsyncWithHttpInfo (string fileId, string productId, string xApiKey, string originalFileId = null);
    ...
    public partial class KeeperApi : IKeeperApi
    {
        ...
        public ApiResponse< List<KeeperFile> > GetAllFilesWithHttpInfo (string productId, string xApiKey, string displayName = null, int? limit = null, int? offset = null, string folderId = null)
        {
            ...
            if (folderId != null) localVarQueryParams.Add("folderId", Configuration.ApiClient.ParameterToString(folderId)); // query parameter
            if (xApiKey != null) localVarHeaderParams.Add("x-api-key", Configuration.ApiClient.ParameterToString(xApiKey)); // header parameter
        ...
        /// <param name="originalFileId"> (optional)</param>
        /// <returns>string</returns>
        public string GetLinkToDownloadOriginalFile (string fileId, string productId, string xApiKey, string originalFileId = null)
        {
             ApiResponse<string> localVarResponse = GetLinkToDownloadOriginalFileWithHttpInfo(fileId, productId, xApiKey, originalFileId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="originalFileId"> (optional)</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > GetLinkToDownloadOriginalFileWithHttpInfo (string fileId, string productId, string xApiKey, string originalFileId = null)
        {
            // verify the required parameter 'fileId' is set
            if (fileId == null)
                throw new ApiException(400, "Missing required parameter 'fileId' when calling KeeperApi->GetLinkToDownloadOriginalFile");
            // verify the required parameter 'productId' is set
            if (productId == null)
                throw new ApiException(400, "Missing required parameter 'productId' when calling KeeperApi->GetLinkToDownloadOriginalFile");
            // verify the required parameter 'xApiKey' is set
            if (xApiKey == null)
                throw new ApiException(400, "Missing required parameter 'xApiKey' when calling KeeperApi->GetLinkToDownloadOriginalFile");

            var localVarPath = "/keeper/{productId}/files/download/{fileId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (fileId != null) localVarPathParams.Add("fileId", Configuration.ApiClient.ParameterToString(fileId)); // path parameter
            if (productId != null) localVarPathParams.Add("productId", Configuration.ApiClient.ParameterToString(productId)); // path parameter
            if (originalFileId != null) localVarQueryParams.Add("originalFileId", Configuration.ApiClient.ParameterToString(originalFileId)); // query parameter
            if (xApiKey != null) localVarHeaderParams.Add("x-api-key", Configuration.ApiClient.ParameterToString(xApiKey)); // header parameter
        ...
        /// <param name="originalFileId"> (optional)</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> GetLinkToDownloadOriginalFileAsync (string fileId, string productId, string xApiKey, string originalFileId = null)
        {
             ApiResponse<string> localVarResponse = await GetLinkToDownloadOriginalFileAsyncWithHttpInfo(fileId, productId, xApiKey, originalFileId);
             return localVarResponse.Data;
        ...
        /// <param name="originalFileId"> (optional)</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> GetLinkToDownloadOriginalFileAsyncWithHttpInfo (string fileId, string productId, string xApiKey, string originalFileId = null)
        {
            // verify the required parameter 'fileId' is set
            if (fileId == null)
                throw new ApiException(400, "Missing required parameter 'fileId' when calling KeeperApi->GetLinkToDownloadOriginalFile");
